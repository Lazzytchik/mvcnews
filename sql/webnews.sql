...
INSERT INTO `groups` (`name`, `ru_name`, `description`) VALUES
('html', 'html', 'Группа статей посвящённая языку разметки html.'),
('javascript', 'javascript', 'Группа посвящённая языку программирования JavaScript.'),
('php', 'php', 'Группа новостей посвящённая языку программирования PHP.'),
('ruby', 'ruby', 'Группа новостей посвящённая языку программирования Ruby.'),
('typescript', 'typescript', 'Группа статей посвящённая языку программирования TypeScript.');
...
('admin', '$2y$10$KNG7RvsUOQZBi/LA5GriwefUUncZjnPQPd2ENqaJd4.16JZPdg1Qq'),
('lazzy', '1234'),
('lazzytchik', '$2y$10$GzrdBzzfHer1rXjPysbPrOUTqT8JIsAIDN1otrKhTGpl9PqGT8dKG');
